...
This will run Tabby locally on CPU, which is not optimal for performance. Depending on your GPU and its compatibility, you may be able to run Tabby with GPU acceleration. As mentioned above, install the appropriate dependancies for your Nvidia or AMD GPU. No extra library installation is necessary for Apple silicon (M1/M2) using Metal.
